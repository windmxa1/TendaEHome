...
public interface OrdersDao {
	 ...
	 * 生成订单
	 */
	public Long generateOrder(Orders orders, List<OrdersDetail> details,List<OrdersGift> gifts);

	/**
	 * 生成订单2
	 */
	public Long generateOrder2(Orders orders,
			Map<String, List<OrdersDetail>> orderMap);
	 ...
	 * 
	 * @param type
	 *            类型，0代表APP，1代表后台,后台申请绑定退款单号到售后单上，app申请绑定退款单号到订单上
	 */
	 ...
	 * 
	 * @param type
	 *            订单类型，0为一米菜园，1为智能家居，2为互助式餐厅
	 */
	List<VOrdersId> getAfterSaleOrder(Long userid, Integer start,
