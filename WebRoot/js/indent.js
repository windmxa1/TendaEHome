...
var builderUQTQueryMsg = function(UQTQueryMsg) {
	...
	$.each(UQTQueryMsg, function(i, eachData) {
		...
		tr.append("<td class='eng_name'>" + orderNum + "</td>" +
			"<td class='query_pro'>" + address + "</td>" +
			"<td class='match_type'>" + status + "</td>" +
			"<td class='match_type'>" + createTime + "</td>" +
			"<td class='dis_dta'>" +
			"<a class='editOp' href='details.html' onclick='details(" + id + ")'>订单详情</a>" +
			"<a class='editOp' href=''  data-toggle='modal' data-target='#xgdd' onclick='updateIndent(" + id + ")'>修改</a>" +
			"</td>" +
