...
var builderUQTQueryMsg = function(UQTQueryMsg) {
	...
	$.each(UQTQueryMsg, function(i, eachData) {
		...
		var goodsName = eachData.goodsName;
		var num = eachData.num;
		var prices = eachData.prices;
		var goodsUrl = eachData.goodsUrl;
		tr.append("<td class='eng_name' title="+orderNum+">" + orderNum + "</td>" +
