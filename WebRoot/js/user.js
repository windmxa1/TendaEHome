...
var builderUQTQueryMsg = function(UQTQueryMsg) {
	...
	var th = '<tr><th scope="col" class="eng_name" style="width:100px">昵称</th><th scope="col" class="query_pro" >联系电话</th><th class="match_type" scope="col">地址</th><th scope="col"  class="match_type">头像</th><th scope="col"  class="dis_order">时间</th><th class="dis_hidden" style="display: none">隐藏属性</th></tr>';
	...
	$.each(UQTQueryMsg, function(i, eachData) {
		...
		tr.append("<td class='eng_name'>" + nickname + "</td>" +
			"<td class='query_pro'>" + phone + "</td>" +
			"<td class='match_type'>" + address + "</td>" +
			"<td class='match_type' title="+txUrl+">" + txUrl + "</td>" +
			"<td class='dis_order'>" + createTime + "</td>" +
